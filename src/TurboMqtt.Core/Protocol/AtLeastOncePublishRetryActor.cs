...
using static TurboMqtt.Core.Protocol.PublishingProtocol;
using static TurboMqtt.Core.Protocol.PublishProtocolDefaults;
    ...
    protected override void OnReceive(object message)
    {
        switch (message)
        {
            ...
            case PublishPacket packet:
            {
                ...
                // we need to send this packet to the server
